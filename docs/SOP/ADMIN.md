...
Admin operasional, staff, produk, website, approval, dan pengaturan outlet.
...
Module/area berdasarkan source `role-access.ts`: pos, kitchen, waiter, inventory, crm, membership, marketing, approvals, website, team-management, settings, recruitment, chat, training, smart-notif.
