...
Kontrol dokumen perusahaan, struktur organisasi, dan area owner-only.
...
Module/area berdasarkan source `role-access.ts`: company-control, dashboard, audit, settings.
