# SOP HR / Team Management

## Purpose

Absensi, shift, SOP, payroll, announcement, dan data staff.
...
Module/area berdasarkan source `role-access.ts`: team-management, attendance, training, staff, payroll.
