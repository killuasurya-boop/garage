# SOP Manager Operasional

## Purpose

Pengendali operasional harian lintas station.
...
Module/area berdasarkan source `role-access.ts`: dashboard, pos, ai-agent, kitchen, waiter, inventory, crm, membership, marketing, approvals, audit, team-management, settings, recruitment, chat, training, smart-notif.
