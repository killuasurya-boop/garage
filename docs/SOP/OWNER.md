...
Pemilik bisnis dan pengambil keputusan akhir.
...
Module/area berdasarkan source `role-access.ts`: dashboard, pos, ai-agent, kitchen, waiter, inventory, finance, crm, membership, marketing, approvals, website, company-control, earnings, audit, team-management, settings, recruitment, chat, training, smart-notif.
