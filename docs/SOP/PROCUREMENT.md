...
Pembelian dan penerimaan supplier. Role khusus belum eksplisit di matrix.
...
Module/area berdasarkan source `role-access.ts`: inventory, finance supplier invoices, supplier receivings.
