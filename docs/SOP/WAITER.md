# SOP Waiter 1 / Waiter 2

## Purpose

Pelayanan meja, antar pesanan, bill request, dan clean table.
...
Module/area berdasarkan source `role-access.ts`: waiter, earnings, ai-agent, chat, training, smart-notif.
