...
export const SETTINGS_CATEGORIES: SettingCategory[] = [
  ...
  },
  {
    id: "attendance",
    label: "Attendance",
    description: "Kontrol absensi, GPS, selfie, toleransi telat, dan double punch.",
    icon: "Users",
    requiredPermission: "staff:manage",
    fields: [
      {
        key: "attendanceEnabled",
        label: "Absensi staff aktif",
        type: "boolean",
        defaultValue: DEFAULT_APP_SETTINGS.attendanceEnabled,
        hint: "Kalau nonaktif, terminal attendance menolak Clock In / Clock Out.",
      },
      {
        key: "attendanceTerminalMode",
        label: "Mode terminal absensi",
        type: "select",
        defaultValue: DEFAULT_APP_SETTINGS.attendanceTerminalMode,
        options: [
          { value: "pin_only", label: "PIN saja" },
          { value: "pin_gps", label: "PIN + GPS" },
          { value: "pin_gps_selfie", label: "PIN + GPS + Selfie" },
        ],
      },
      {
        key: "attendanceLateGraceMinutes",
        label: "Toleransi telat",
        type: "number",
        defaultValue: DEFAULT_APP_SETTINGS.attendanceLateGraceMinutes,
        min: 0,
        max: 120,
        step: 1,
        unit: "menit",
      ...
      {
        key: "attendanceEarlyLeaveGraceMinutes",
        label: "Toleransi pulang cepat",
        type: "number",
        defaultValue: DEFAULT_APP_SETTINGS.attendanceEarlyLeaveGraceMinutes,
        min: 0,
        max: 120,
        step: 1,
        unit: "menit",
      ...
      {
        key: "attendanceRequireGps",
        label: "GPS wajib",
        type: "boolean",
        defaultValue: DEFAULT_APP_SETTINGS.attendanceRequireGps,
        hint: "Dipakai untuk mode selain PIN saja. Matikan hanya untuk kondisi darurat device/GPS.",
      },
      {
        key: "attendanceRequireActiveGeofence",
        label: "Wajib ada lokasi presensi",
        type: "boolean",
        defaultValue: DEFAULT_APP_SETTINGS.attendanceRequireActiveGeofence,
        hint: "Kalau aktif, outlet tanpa lokasi presensi tidak bisa menerima absensi GPS.",
      },
      {
        key: "attendanceRequireSelfie",
        label: "Selfie wajib",
        type: "boolean",
        defaultValue: DEFAULT_APP_SETTINGS.attendanceRequireSelfie,
        hint: "Mode PIN + GPS + Selfie selalu mewajibkan selfie meskipun toggle ini mati.",
      },
      {
        key: "attendanceBlockDoublePunch",
        label: "Blok double punch",
        type: "boolean",
        defaultValue: DEFAULT_APP_SETTINGS.attendanceBlockDoublePunch,
        hint: "Cegah Clock In dua kali dan Clock Out tanpa Clock In aktif.",
      },
    ],
  },
  {
